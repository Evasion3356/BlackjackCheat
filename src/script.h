...
// Matches the ScriptHookRDR2 SDK sample convention, same as PokerCheat's
// script.h: the common header that pulls in the native/type/enum
// declarations plus the script registration macros.
//
